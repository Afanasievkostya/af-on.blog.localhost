                    ...
                    <div class="text-title">
                       ...
                       <div class="card mb-3 card-video">
                         <div>
                           ...
                           <source src="/video/<?= $movies->video?>" type='video/ogg; codecs="theora, vorbis"'>
                           <source src="/video/<?= $movies->video?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
                           <source src="/video/<?= $movies->video?>" type='video/webm; codecs="vp8, vorbis"'>
                          ...
                          <div class="card-body">
                             ...
                             <p class="card-text"><small class="text-muted"><?= $movies->date?></small></p>
