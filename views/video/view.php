                    ...
                    <?php foreach ($videos as $video): ?>
                      <div class="card mb-3 card-video">
                        <div>
                          ...
                          <source src="/video/<?= $video->video?>" type='video/ogg; codecs="theora, vorbis"'>
                          <source src="/video/<?= $video->video?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
                          <source src="/video/<?= $video->video?>" type='video/webm; codecs="vp8, vorbis"'>
